...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 60/43.6;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap, Telemetry telemetry, DirectionEnum direction) {
        super(kV, kA, kStatic, TRACK_WIDTH, TRACK_WIDTH, LATERAL_MULTIPLIER);
        this.telemetry = telemetry;

        follower = new HolonomicPIDVAFollower(HEADING_PID, TRANSLATIONAL_PID, TRANSLATIONAL_PID,
                new Pose2d(Math.toRadians(5.0), 0.5, 0.5), 0.5);
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "back_left_wheel");
            leftRear = hardwareMap.get(DcMotorEx.class, "front_left_wheel");
            rightRear = hardwareMap.get(DcMotorEx.class, "back_right_wheel");
    ...
    public void initialzeAttachments(HardwareMap hardwareMap) {
...
//        colorSensor2 = hardwareMap.colorSensor.get("colorSensor2");
    ...
    public void reset_angle() {this.reset_angle = driveTrain.getExternalHeading() + this.reset_angle;}
